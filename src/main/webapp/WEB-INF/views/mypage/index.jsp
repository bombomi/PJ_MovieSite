...
function loadPage(value) {
	...
	case 2:
		...
		break;
	case 3:
		document.getElementById("right_pane").innerHTML = '<object style="width:100%;height:100%" type="text/html" data="/mymovie/myPage/withdrawal" ></object>';
...
<div class="container-fluid">
	...
	<div class="row body-fill">
		...
		<div class="w-75 p-3 border-top" id="right_pane">
		</div>
	</div>
</div>
</body>
